<template>
    <div>
        <div v-for="(file,index) of file" :key="index">
            <el-row>
                ...
                <el-col :span="18" id="nav_class">
                    <div class="nav">
                        <el-row class="nav_left">
                            <el-col :span="4">房屋介绍</el-col>
                            <el-col :span="4">房屋位置</el-col>
                            <el-col :span="4">入住须知</el-col>
                            <el-col :span="4">额外费用</el-col>
                        </el-row>
                    </div>
                </el-col>
            ...
            <el-row class="main"> 
                <el-col :span="24" class="main_body">
                    <el-row :gutter="5">
                        <el-col :span="12" class="main_floor">
                            <div class="main_floor_title">{{file.title}}</div>
                            <div class="main_floor_dizhi">地址：{{file.address}}<a href="#">查看地图</a></div>
                                        ...
                                        <div class="main_sbfu">
                                            <ul style="list-style: none">
                                                <li>
                                                    ...
                                                    <p><i class="iconserver icon2"></i>空调（冷暖)</p>
                            ...
                            <div class="main_fwwz">
                                <div class="main_fwms_title main_fwwz_title">房屋位置</div>
...
<style>
    ...
    .main_floor_icon{
        width: 28px;
        height: 28px;
        background-image: url(../assets/images/house_icon.png);
        margin-left: 30px;
    }
    .icon_fwlx{
    ...
    .iconserver{
        width: 20px;
        height: 20px;
        background-image:url(../assets/images/houseService-icon.png);
    }
    .icon1{
